...
public class MyTournamentObserver extends TournamentObserver {
   ...
   */
  MyDiplomacyMonitor diplomacyMonitor;
  ...
  public MyTournamentObserver(String tournamentLogFolderPath, ArrayList<ScoreCalculator> scoreCalculators, int numGames, int numParticipants) throws IOException {
    super(tournamentLogFolderPath, scoreCalculators, numGames, numParticipants);
    ...
    this.diplomacyMonitor = new MyDiplomacyMonitor(numParticipants, scoreCalculators);
  }
